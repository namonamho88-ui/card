...
const AI_INSIGHTS = [
  ...
  { icon: '🍣', title: '초밥 먹는 순서', body: '흰살 생선에서 붉은살 생선, 그리고 간이 센 양념 초밥 순으로 드하시면 각 재료의 맛을 온전히 즐길 수 있습니다.' },
  ...
  { icon: '🥬', title: '쌈 채소의 정석', body: '깻잎은 뒷면이 더 거칠기 때문에 고기를 얹을 때 뒷면이 위로 오게 하면 입안에 닿는 느낌이 훨씬 부드럽습니다.' },
  { icon: '🍙', title: '삼각김밥 200% 즐기기', body: '전자레인지에 딱 20초만 데워보세요. 눅눅했던 김이 바삭해지고 밥알의 식감이 살아납니다.' },
  { icon: '🏛️', title: '을지로 건축 유산', body: '을지로의 오래된 건물들은 1970년대 산업화 시대를 상징합니다. 낡은 외벽 안에는 힙한 감성의 카페들이 숨어있죠.' },
  { icon: '📸', title: '음식 사진 잘 찍는 법', body: '자연광 아래서 45도 각도로 촬영해보세요. 그림자가 살짝 생기며 음식의 입체감이 살아납니다.' },
  { icon: '🍶', title: '전통주 페어링', body: '기름진 전에는 탄산감 있는 막걸리가, 담백한 회에는 깔끔한 청주가 최고의 조합입니다.' },
  { icon: '🚶', title: '식후 산책 코스', body: '을지로에서 식사 후 청계천을 따라 걷는 코스는 약 15분이 소요되며 소화에 가장 적당한 거리입니다.' },
  { icon: '🕰️', title: '노포 맛집의 비밀', body: '30년 넘게 한 자리를 지킨 식당들은 대물림되는 육수나 양념 비법을 하나씩 꼭 가지고 있습니다.' },
];
