...
const FINANCIAL_INSIGHTS = [
    ...
    { icon: '🎯', title: '내 차례는 언제?', body: '신용대출 금리가 고민이라면 신한 쏠(SOL) 앱에서 실시간으로 금리 인하 요구권을 행사할 수 있는지 체크해보세요.' },
    { icon: '🎁', title: '생일 축하 혜택', body: '신한카드 마이샵(MyShop)에는 생일 달에만 제공되는 특별한 쿠폰과 캐시백 혜택이 숨어있습니다.' },
    { icon: '🛫', title: '해외 여행 가기 전', body: '해외 결제 시 현지 통화로 결제(DCC 차단)해야 불필요한 이중 환전 수수료를 아낄 수 있습니다.' },
    { icon: '📉', title: '분할 매수의 힘', body: '변동성이 큰 시장에서는 한 번에 투자하기보다 매달 정해진 금액을 나누어 투자하는 것이 리스크 관리에 유리합니다.' },
    { icon: '🧸', title: '자녀 경제 교육', body: '신한카드 ‘픽(Pick) E/L 선불카드’로 자녀에게 올바른 소비 습관과 용돈 관리법을 가르쳐줄 수 있습니다.' },
    { icon: '🚗', title: '주유비 절약', body: '자주 가는 주유소가 신한카드 제휴처인지 확인해보세요. 리터당 60~100원까지 적립되는 카드가 많습니다.' },
    { icon: '🏦', title: 'ISA 계좌의 마법', body: '개인종합자산관리계좌(ISA)를 활용하면 투자 수익의 일정 금액까지 비과세 혜택을 받을 수 있는 ‘절세 만능 통장’입니다.' },
    { icon: '📱', title: '카드 분실 시 대처', body: '카드를 잃어버렸다면 즉시 앱에서 ‘일시정지’ 기능을 켜세요. 찾게 되면 바로 해제할 수 있어 편리합니다.' },
    { icon: '🧾', title: '연말정산 꿀팁', body: '신용카드보다 체크카드와 현금영수증의 소득공제율이 2배 높습니다. 총급여의 25% 초과 지출분부터 전략적으로 사용하세요.' },
    { icon: '🛡️', title: '피싱 범죄 예방', body: '출처가 불분명한 URL이나 문자의 링크는 절대 클릭하지 마세요. 신한금융은 절대 문자로 개인정보를 요구하지 않습니다.' },
];
